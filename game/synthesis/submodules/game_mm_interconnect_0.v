...
module game_mm_interconnect_0 (
		...
		output wire [2:0]  timer_game_s1_address,                   //                   timer_game_s1.address
		output wire        timer_game_s1_write,                     //                                .write
		input  wire [15:0] timer_game_s1_readdata,                  //                                .readdata
		output wire [15:0] timer_game_s1_writedata,                 //                                .writedata
		output wire        timer_game_s1_chipselect,                //                                .chipselect
		output wire [2:0]  timer_lcd_s1_address,                    //                    timer_lcd_s1.address
		output wire        timer_lcd_s1_write,                      //                                .write
		input  wire [15:0] timer_lcd_s1_readdata,                   //                                .readdata
		output wire [15:0] timer_lcd_s1_writedata,                  //                                .writedata
		output wire        timer_lcd_s1_chipselect                  //                                .chipselect
	);
	...
	wire  [96:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> onchip_ram_s1_agent:cp_data
	...
	wire  [96:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> key_s1_agent:cp_data
	...
	wire  [18:0] hex_s1_agent_m0_address;                                                   // hex_s1_agent:m0_address -> hex_s1_translator:uav_address
	...
	wire  [97:0] hex_s1_agent_rf_source_data;                                               // hex_s1_agent:rf_source_data -> hex_s1_agent_rsp_fifo:in_data
	...
	wire  [97:0] hex_s1_agent_rsp_fifo_out_data;                                            // hex_s1_agent_rsp_fifo:out_data -> hex_s1_agent:rf_sink_data
	...
	wire  [96:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> hex_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                     // hex_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [9:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> hex_s1_agent:cp_channel
	...
	wire  [18:0] lcd_s1_agent_m0_address;                                                   // lcd_s1_agent:m0_address -> lcd_s1_translator:uav_address
	...
	wire  [96:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> lcd_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                     // lcd_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [9:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> lcd_s1_agent:cp_channel
	...
	wire  [31:0] timer_game_s1_agent_m0_readdata;                                           // timer_game_s1_translator:uav_readdata -> timer_game_s1_agent:m0_readdata
	wire         timer_game_s1_agent_m0_waitrequest;                                        // timer_game_s1_translator:uav_waitrequest -> timer_game_s1_agent:m0_waitrequest
	wire         timer_game_s1_agent_m0_debugaccess;                                        // timer_game_s1_agent:m0_debugaccess -> timer_game_s1_translator:uav_debugaccess
	wire  [18:0] timer_game_s1_agent_m0_address;                                            // timer_game_s1_agent:m0_address -> timer_game_s1_translator:uav_address
	wire   [3:0] timer_game_s1_agent_m0_byteenable;                                         // timer_game_s1_agent:m0_byteenable -> timer_game_s1_translator:uav_byteenable
	wire         timer_game_s1_agent_m0_read;                                               // timer_game_s1_agent:m0_read -> timer_game_s1_translator:uav_read
	wire         timer_game_s1_agent_m0_readdatavalid;                                      // timer_game_s1_translator:uav_readdatavalid -> timer_game_s1_agent:m0_readdatavalid
	wire         timer_game_s1_agent_m0_lock;                                               // timer_game_s1_agent:m0_lock -> timer_game_s1_translator:uav_lock
	wire  [31:0] timer_game_s1_agent_m0_writedata;                                          // timer_game_s1_agent:m0_writedata -> timer_game_s1_translator:uav_writedata
	wire         timer_game_s1_agent_m0_write;                                              // timer_game_s1_agent:m0_write -> timer_game_s1_translator:uav_write
	wire   [2:0] timer_game_s1_agent_m0_burstcount;                                         // timer_game_s1_agent:m0_burstcount -> timer_game_s1_translator:uav_burstcount
	wire         timer_game_s1_agent_rf_source_valid;                                       // timer_game_s1_agent:rf_source_valid -> timer_game_s1_agent_rsp_fifo:in_valid
	wire  [97:0] timer_game_s1_agent_rf_source_data;                                        // timer_game_s1_agent:rf_source_data -> timer_game_s1_agent_rsp_fifo:in_data
	wire         timer_game_s1_agent_rf_source_ready;                                       // timer_game_s1_agent_rsp_fifo:in_ready -> timer_game_s1_agent:rf_source_ready
	wire         timer_game_s1_agent_rf_source_startofpacket;                               // timer_game_s1_agent:rf_source_startofpacket -> timer_game_s1_agent_rsp_fifo:in_startofpacket
	wire         timer_game_s1_agent_rf_source_endofpacket;                                 // timer_game_s1_agent:rf_source_endofpacket -> timer_game_s1_agent_rsp_fifo:in_endofpacket
	wire         timer_game_s1_agent_rsp_fifo_out_valid;                                    // timer_game_s1_agent_rsp_fifo:out_valid -> timer_game_s1_agent:rf_sink_valid
	wire  [97:0] timer_game_s1_agent_rsp_fifo_out_data;                                     // timer_game_s1_agent_rsp_fifo:out_data -> timer_game_s1_agent:rf_sink_data
	wire         timer_game_s1_agent_rsp_fifo_out_ready;                                    // timer_game_s1_agent:rf_sink_ready -> timer_game_s1_agent_rsp_fifo:out_ready
	wire         timer_game_s1_agent_rsp_fifo_out_startofpacket;                            // timer_game_s1_agent_rsp_fifo:out_startofpacket -> timer_game_s1_agent:rf_sink_startofpacket
	wire         timer_game_s1_agent_rsp_fifo_out_endofpacket;                              // timer_game_s1_agent_rsp_fifo:out_endofpacket -> timer_game_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_008_src_valid;                                                     // cmd_mux_008:src_valid -> timer_game_s1_agent:cp_valid
	wire  [96:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> timer_game_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                     // timer_game_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [9:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> timer_game_s1_agent:cp_channel
	wire         cmd_mux_008_src_startofpacket;                                             // cmd_mux_008:src_startofpacket -> timer_game_s1_agent:cp_startofpacket
	wire         cmd_mux_008_src_endofpacket;                                               // cmd_mux_008:src_endofpacket -> timer_game_s1_agent:cp_endofpacket
	wire  [31:0] timer_lcd_s1_agent_m0_readdata;                                            // timer_lcd_s1_translator:uav_readdata -> timer_lcd_s1_agent:m0_readdata
	wire         timer_lcd_s1_agent_m0_waitrequest;                                         // timer_lcd_s1_translator:uav_waitrequest -> timer_lcd_s1_agent:m0_waitrequest
	wire         timer_lcd_s1_agent_m0_debugaccess;                                         // timer_lcd_s1_agent:m0_debugaccess -> timer_lcd_s1_translator:uav_debugaccess
	wire  [18:0] timer_lcd_s1_agent_m0_address;                                             // timer_lcd_s1_agent:m0_address -> timer_lcd_s1_translator:uav_address
	wire   [3:0] timer_lcd_s1_agent_m0_byteenable;                                          // timer_lcd_s1_agent:m0_byteenable -> timer_lcd_s1_translator:uav_byteenable
	wire         timer_lcd_s1_agent_m0_read;                                                // timer_lcd_s1_agent:m0_read -> timer_lcd_s1_translator:uav_read
	wire         timer_lcd_s1_agent_m0_readdatavalid;                                       // timer_lcd_s1_translator:uav_readdatavalid -> timer_lcd_s1_agent:m0_readdatavalid
	wire         timer_lcd_s1_agent_m0_lock;                                                // timer_lcd_s1_agent:m0_lock -> timer_lcd_s1_translator:uav_lock
	wire  [31:0] timer_lcd_s1_agent_m0_writedata;                                           // timer_lcd_s1_agent:m0_writedata -> timer_lcd_s1_translator:uav_writedata
	wire         timer_lcd_s1_agent_m0_write;                                               // timer_lcd_s1_agent:m0_write -> timer_lcd_s1_translator:uav_write
	wire   [2:0] timer_lcd_s1_agent_m0_burstcount;                                          // timer_lcd_s1_agent:m0_burstcount -> timer_lcd_s1_translator:uav_burstcount
	wire         timer_lcd_s1_agent_rf_source_valid;                                        // timer_lcd_s1_agent:rf_source_valid -> timer_lcd_s1_agent_rsp_fifo:in_valid
	wire  [97:0] timer_lcd_s1_agent_rf_source_data;                                         // timer_lcd_s1_agent:rf_source_data -> timer_lcd_s1_agent_rsp_fifo:in_data
	wire         timer_lcd_s1_agent_rf_source_ready;                                        // timer_lcd_s1_agent_rsp_fifo:in_ready -> timer_lcd_s1_agent:rf_source_ready
	wire         timer_lcd_s1_agent_rf_source_startofpacket;                                // timer_lcd_s1_agent:rf_source_startofpacket -> timer_lcd_s1_agent_rsp_fifo:in_startofpacket
	wire         timer_lcd_s1_agent_rf_source_endofpacket;                                  // timer_lcd_s1_agent:rf_source_endofpacket -> timer_lcd_s1_agent_rsp_fifo:in_endofpacket
	wire         timer_lcd_s1_agent_rsp_fifo_out_valid;                                     // timer_lcd_s1_agent_rsp_fifo:out_valid -> timer_lcd_s1_agent:rf_sink_valid
	wire  [97:0] timer_lcd_s1_agent_rsp_fifo_out_data;                                      // timer_lcd_s1_agent_rsp_fifo:out_data -> timer_lcd_s1_agent:rf_sink_data
	wire         timer_lcd_s1_agent_rsp_fifo_out_ready;                                     // timer_lcd_s1_agent:rf_sink_ready -> timer_lcd_s1_agent_rsp_fifo:out_ready
	wire         timer_lcd_s1_agent_rsp_fifo_out_startofpacket;                             // timer_lcd_s1_agent_rsp_fifo:out_startofpacket -> timer_lcd_s1_agent:rf_sink_startofpacket
	wire         timer_lcd_s1_agent_rsp_fifo_out_endofpacket;                               // timer_lcd_s1_agent_rsp_fifo:out_endofpacket -> timer_lcd_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_009_src_valid;                                                     // cmd_mux_009:src_valid -> timer_lcd_s1_agent:cp_valid
	wire  [96:0] cmd_mux_009_src_data;                                                      // cmd_mux_009:src_data -> timer_lcd_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                     // timer_lcd_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [9:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> timer_lcd_s1_agent:cp_channel
	wire         cmd_mux_009_src_startofpacket;                                             // cmd_mux_009:src_startofpacket -> timer_lcd_s1_agent:cp_startofpacket
	wire         cmd_mux_009_src_endofpacket;                                               // cmd_mux_009:src_endofpacket -> timer_lcd_s1_agent:cp_endofpacket
	...
	wire  [96:0] onchip_ram_s1_agent_rp_data;                                               // onchip_ram_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [96:0] key_s1_agent_rp_data;                                                      // key_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [96:0] hex_s1_agent_rp_data;                                                      // hex_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [96:0] lcd_s1_agent_rp_data;                                                      // lcd_s1_agent:rp_data -> router_009:sink_data
	...
	wire         timer_game_s1_agent_rp_valid;                                              // timer_game_s1_agent:rp_valid -> router_010:sink_valid
	wire  [96:0] timer_game_s1_agent_rp_data;                                               // timer_game_s1_agent:rp_data -> router_010:sink_data
	wire         timer_game_s1_agent_rp_ready;                                              // router_010:sink_ready -> timer_game_s1_agent:rp_ready
	wire         timer_game_s1_agent_rp_startofpacket;                                      // timer_game_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire         timer_game_s1_agent_rp_endofpacket;                                        // timer_game_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire         timer_lcd_s1_agent_rp_valid;                                               // timer_lcd_s1_agent:rp_valid -> router_011:sink_valid
	wire  [96:0] timer_lcd_s1_agent_rp_data;                                                // timer_lcd_s1_agent:rp_data -> router_011:sink_data
	wire         timer_lcd_s1_agent_rp_ready;                                               // router_011:sink_ready -> timer_lcd_s1_agent:rp_ready
	wire         timer_lcd_s1_agent_rp_startofpacket;                                       // timer_lcd_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire         timer_lcd_s1_agent_rp_endofpacket;                                         // timer_lcd_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire         timer_game_s1_agent_rdata_fifo_src_valid;                                  // timer_game_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire  [33:0] timer_game_s1_agent_rdata_fifo_src_data;                                   // timer_game_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire         timer_game_s1_agent_rdata_fifo_src_ready;                                  // avalon_st_adapter_008:in_0_ready -> timer_game_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_008_out_0_valid;                                         // avalon_st_adapter_008:out_0_valid -> timer_game_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_008_out_0_data;                                          // avalon_st_adapter_008:out_0_data -> timer_game_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_008_out_0_ready;                                         // timer_game_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire   [0:0] avalon_st_adapter_008_out_0_error;                                         // avalon_st_adapter_008:out_0_error -> timer_game_s1_agent:rdata_fifo_sink_error
	wire         timer_lcd_s1_agent_rdata_fifo_src_valid;                                   // timer_lcd_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire  [33:0] timer_lcd_s1_agent_rdata_fifo_src_data;                                    // timer_lcd_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire         timer_lcd_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_009:in_0_ready -> timer_lcd_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_009_out_0_valid;                                         // avalon_st_adapter_009:out_0_valid -> timer_lcd_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_009_out_0_data;                                          // avalon_st_adapter_009:out_0_data -> timer_lcd_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_009_out_0_ready;                                         // timer_lcd_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire   [0:0] avalon_st_adapter_009_out_0_error;                                         // avalon_st_adapter_009:out_0_error -> timer_lcd_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) timer_game_s1_translator (
		.clk                    (clk_main_clk_clk),                      //                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (timer_game_s1_agent_m0_address),        // avalon_universal_slave_0.address
		.uav_burstcount         (timer_game_s1_agent_m0_burstcount),     //                         .burstcount
		.uav_read               (timer_game_s1_agent_m0_read),           //                         .read
		.uav_write              (timer_game_s1_agent_m0_write),          //                         .write
		.uav_waitrequest        (timer_game_s1_agent_m0_waitrequest),    //                         .waitrequest
		.uav_readdatavalid      (timer_game_s1_agent_m0_readdatavalid),  //                         .readdatavalid
		.uav_byteenable         (timer_game_s1_agent_m0_byteenable),     //                         .byteenable
		.uav_readdata           (timer_game_s1_agent_m0_readdata),       //                         .readdata
		.uav_writedata          (timer_game_s1_agent_m0_writedata),      //                         .writedata
		.uav_lock               (timer_game_s1_agent_m0_lock),           //                         .lock
		.uav_debugaccess        (timer_game_s1_agent_m0_debugaccess),    //                         .debugaccess
		.av_address             (timer_game_s1_address),                 //      avalon_anti_slave_0.address
		.av_write               (timer_game_s1_write),                   //                         .write
		.av_readdata            (timer_game_s1_readdata),                //                         .readdata
		.av_writedata           (timer_game_s1_writedata),               //                         .writedata
		.av_chipselect          (timer_game_s1_chipselect),              //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) timer_lcd_s1_translator (
		.clk                    (clk_main_clk_clk),                      //                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (timer_lcd_s1_agent_m0_address),         // avalon_universal_slave_0.address
		.uav_burstcount         (timer_lcd_s1_agent_m0_burstcount),      //                         .burstcount
		.uav_read               (timer_lcd_s1_agent_m0_read),            //                         .read
		.uav_write              (timer_lcd_s1_agent_m0_write),           //                         .write
		.uav_waitrequest        (timer_lcd_s1_agent_m0_waitrequest),     //                         .waitrequest
		.uav_readdatavalid      (timer_lcd_s1_agent_m0_readdatavalid),   //                         .readdatavalid
		.uav_byteenable         (timer_lcd_s1_agent_m0_byteenable),      //                         .byteenable
		.uav_readdata           (timer_lcd_s1_agent_m0_readdata),        //                         .readdata
		.uav_writedata          (timer_lcd_s1_agent_m0_writedata),       //                         .writedata
		.uav_lock               (timer_lcd_s1_agent_m0_lock),            //                         .lock
		.uav_debugaccess        (timer_lcd_s1_agent_m0_debugaccess),     //                         .debugaccess
		.av_address             (timer_lcd_s1_address),                  //      avalon_anti_slave_0.address
		.av_write               (timer_lcd_s1_write),                    //                         .write
		.av_readdata            (timer_lcd_s1_readdata),                 //                         .readdata
		.av_writedata           (timer_lcd_s1_writedata),                //                         .writedata
		.av_chipselect          (timer_lcd_s1_chipselect),               //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_main_clk_clk),                               //             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),          //       clk_reset.reset
		.m0_address              (timer_game_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (timer_game_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (timer_game_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (timer_game_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (timer_game_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (timer_game_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (timer_game_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (timer_game_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (timer_game_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (timer_game_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (timer_game_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (timer_game_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (timer_game_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (timer_game_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (timer_game_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (timer_game_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (timer_game_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (timer_game_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (timer_game_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (timer_game_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (timer_game_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (timer_game_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (timer_game_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (timer_game_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (timer_game_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (timer_game_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_008_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_008_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_008_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_008_out_0_error),              //                .error
		.rdata_fifo_src_ready    (timer_game_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (timer_game_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (timer_game_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) timer_game_s1_agent_rsp_fifo (
		.clk               (clk_main_clk_clk),                               //       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),          // clk_reset.reset
		.in_data           (timer_game_s1_agent_rf_source_data),             //        in.data
		.in_valid          (timer_game_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (timer_game_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (timer_game_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (timer_game_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (timer_game_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (timer_game_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (timer_game_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (timer_game_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (timer_game_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_main_clk_clk),                              //             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),         //       clk_reset.reset
		.m0_address              (timer_lcd_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (timer_lcd_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (timer_lcd_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (timer_lcd_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (timer_lcd_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (timer_lcd_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (timer_lcd_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (timer_lcd_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (timer_lcd_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (timer_lcd_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (timer_lcd_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (timer_lcd_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (timer_lcd_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (timer_lcd_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (timer_lcd_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (timer_lcd_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (timer_lcd_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (timer_lcd_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (timer_lcd_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (timer_lcd_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (timer_lcd_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (timer_lcd_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (timer_lcd_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (timer_lcd_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (timer_lcd_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (timer_lcd_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_009_out_0_ready),             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_009_out_0_valid),             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_009_out_0_data),              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_009_out_0_error),             //                .error
		.rdata_fifo_src_ready    (timer_lcd_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (timer_lcd_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (timer_lcd_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) timer_lcd_s1_agent_rsp_fifo (
		.clk               (clk_main_clk_clk),                              //       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),         // clk_reset.reset
		.in_data           (timer_lcd_s1_agent_rf_source_data),             //        in.data
		.in_valid          (timer_lcd_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (timer_lcd_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (timer_lcd_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (timer_lcd_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (timer_lcd_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (timer_lcd_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (timer_lcd_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (timer_lcd_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (timer_lcd_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	game_mm_interconnect_0_router router (
	...
	game_mm_interconnect_0_router_001 router_001 (
	...
	game_mm_interconnect_0_router_002 router_002 (
	...
	game_mm_interconnect_0_router_003 router_003 (
	...
	game_mm_interconnect_0_router_003 router_004 (
	...
	game_mm_interconnect_0_router_002 router_005 (
	...
	game_mm_interconnect_0_router_002 router_006 (
	...
	game_mm_interconnect_0_router_002 router_007 (
	...
	game_mm_interconnect_0_router_002 router_008 (
	...
	game_mm_interconnect_0_router_002 router_009 (
	...
	game_mm_interconnect_0_router_002 router_010 (
		.sink_ready         (timer_game_s1_agent_rp_ready),          //      sink.ready
		.sink_valid         (timer_game_s1_agent_rp_valid),          //          .valid
		.sink_data          (timer_game_s1_agent_rp_data),           //          .data
		.sink_startofpacket (timer_game_s1_agent_rp_startofpacket),  //          .startofpacket
		.sink_endofpacket   (timer_game_s1_agent_rp_endofpacket),    //          .endofpacket
		.clk                (clk_main_clk_clk),                      //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_router_002 router_011 (
		.sink_ready         (timer_lcd_s1_agent_rp_ready),           //      sink.ready
		.sink_valid         (timer_lcd_s1_agent_rp_valid),           //          .valid
		.sink_data          (timer_lcd_s1_agent_rp_data),            //          .data
		.sink_startofpacket (timer_lcd_s1_agent_rp_startofpacket),   //          .startofpacket
		.sink_endofpacket   (timer_lcd_s1_agent_rp_endofpacket),     //          .endofpacket
		.clk                (clk_main_clk_clk),                      //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_main_clk_clk),                      //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_main_clk_clk),                      //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_main_clk_clk),                      //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_main_clk_clk),                      //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_main_clk_clk),                      //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_main_clk_clk),                      //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_main_clk_clk),                      //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_main_clk_clk),                      //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_main_clk_clk),                      //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (clk_main_clk_clk),                      //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (clk_main_clk_clk),                      //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_cmd_mux cmd_mux_009 (
		.clk                 (clk_main_clk_clk),                      //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_main_clk_clk),                      //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_main_clk_clk),                      //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_main_clk_clk),                      //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_main_clk_clk),                      //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_main_clk_clk),                      //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_main_clk_clk),                      //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_main_clk_clk),                      //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (clk_main_clk_clk),                      //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (clk_main_clk_clk),                      //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_rsp_demux rsp_demux_009 (
		.clk                (clk_main_clk_clk),                      //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_main_clk_clk),                      //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_main_clk_clk),                      //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	game_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	game_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_main_clk_clk),                         // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_reset_bridge_in_reset_reset),    // in_rst_0.reset
		.in_0_data      (timer_game_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (timer_game_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (timer_game_s1_agent_rdata_fifo_src_ready), //         .ready
	...
	game_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_main_clk_clk),                        // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_reset_bridge_in_reset_reset),   // in_rst_0.reset
		.in_0_data      (timer_lcd_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (timer_lcd_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (timer_lcd_s1_agent_rdata_fifo_src_ready), //         .ready
